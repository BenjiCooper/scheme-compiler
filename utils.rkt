...
(define (simplify-ir ir-e)
  (define (T e)
    (match e
      ...
      [`(prim string-append)
       ''""]
      [`(prim string-append ,s)
       (T s)]
      [`(prim string-append ,s1 ,s2 ,s3 ,ss ...)
       (T `(prim string-append ,s1 (prim string-append ,s2 ,s3 ,@ss)))]

      [`(prim string) ''""]
      [`(prim string (quote ,s)) (T `(quote ,(string s)))]
      [`(prim string (quote ,s1) ,s2 ,ss ...)
       (T `(prim string-append ',(string s1) (prim string ,s2 ,@ss)))]

      [`(prim string->list (quote ,s)) (T `(quote ,(string->list s)))]
